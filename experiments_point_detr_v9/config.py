"""Configuration for Point-RT V9 (Iterative Point Set Refinement)."""
...
@dataclass
class ModelConfig:
    """Point-RT model configuration (iterative refinement)."""
...
class TrainingConfig:
    ...
    # Output
    output_dir: str = "./outputs_point_detr_v9"
    checkpoint_path: Optional[str] = None
    
    # Logging
    use_wandb: bool = True
    wandb_project: str = "PointRT-Unsupervised"
    wandb_run_name: Optional[str] = "v9_refiner"
...
class DataConfig:
    ...
    source_dir: str = "/groups/asharf_group/ofirgila/ControlNet/training/data_grads_v3_2048/source"
    target_dir: Optional[str] = "/groups/asharf_group/ofirgila/ControlNet/training/data_grads_v3_2048/target"  # Optional for eval
