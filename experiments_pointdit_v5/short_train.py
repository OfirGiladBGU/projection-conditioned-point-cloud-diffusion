...
Usage:
    ...
    # Or on GPU node:
    ssh ise-cpu256-26 "cd /groups/asharf_group/ofirgila/projection-conditioned-point-cloud-diffusion/experiments_pointdit_v5 && source ~/.bashrc && conda activate pc2 && python short_train.py"
"""
