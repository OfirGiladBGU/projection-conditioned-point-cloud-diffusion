"""Overfitting test for Point-DiT V4 (x_start prediction) on a single image."""
...
def visualize_sample(img_tensor: torch.Tensor, gt_pts: torch.Tensor, pred_pts: torch.Tensor, save_path: str):
...
parser = argparse.ArgumentParser(description="Overfit Point-DiT V4 on a single sample")
...
print("Point-DiT V4 model created")
...
print("\n" + "=" * 60)
print("OVERFITTING TEST: PointDiT V5 (Fourier + Repulsion)")
print("=" * 60)
...
# Save normalized coordinates (for quantitative analysis)
...
visualize_sample(image, points, sampled_points, vis_path)
